export const filterData = [ {name:"Noti",image: require('../../assets/ride.png'), id:"0"},
                            {name:"Equ",image:require("../../assets/food.png"),id:"1"},
                            {name:"Rec",image:require("../../assets/package.png"),id:"2"},
                            {name:"Sta",image:require("../../assets/reserve.png"),id:"3"}
                           ];


export const rideData =[
    {street:"Lafayette",area:"Rue liberté",id:"0"},
    {street:"Tunis",area:"Rue Louay Bray",id:"1"},
    {street:"Lafayette",area:" East Rand,Ekurhuleni,Gauteng,1459",id:"2"},
    {street:"Lafayette",area:"35 Atlas Rd,Anderbolt,Boksburg",id:"3"},
    {street:"Lafayette",area:"Bezuidenhout Valley,Johannesburg",id:"4"},
];
